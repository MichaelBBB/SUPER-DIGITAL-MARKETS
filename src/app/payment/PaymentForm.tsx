    ...
    try {
      ...
      if (!res.ok) {
        if (data.fallback === 'whatsapp') {
          if (confirm("Peach Payments is currently unavailable. Use WhatsApp instead?")) {
            handleWhatsAppOrder();
          }
        } else {
        ...
        <div>
          ...
          >
            ...
            <p className="text-gray-300 mb-4">
              Pay securely with Card or Instant EFT. Automated delivery after verification.
            </p>
          ...
          <div className="bg-green-900/20 border border-green-500/30 rounded-xl p-6 mb-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-bold text-green-400">Option 2: WhatsApp (Fastest)</h3>
            </div>
            <p className="text-gray-300 mb-4">
              Click the green button to open WhatsApp and confirm your order.
            </p>
        ...
        <div>
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 relative">
            ...
            <p className="text-center text-xs text-gray-500 mt-6">
              After transferring, email POP to <a href="mailto:payments@superdigital.store" className="text-cyan-400 hover:underline">payments@superdigital.store</a>
            </p>
          </div>
        </div>
