...
export default function PaymentForm({ 
  ...
  // Step 2: Auto-Redirect to Peach when ID is ready
  useEffect(() => {
    if (checkoutId) {
      const peachUrl = `https://secure.peachpayments.com/v2/checkout?checkoutId=${checkoutId}`;
      console.log(' Redirecting to:', peachUrl);
      // Optional: Redirect immediately, or wait for user to click button below
      // window.location.href = peachUrl; 
    }
  }, [checkoutId]);
          ...
          <div className="border-2 border-green-500 bg-gray-800 rounded-lg p-6">
            ...
            {loading ? (
              ...
              <div className="h-[300px] flex flex-col items-center justify-center bg-green-900/10 rounded-lg border border-green-500/20">
                ...
                <p className="text-gray-400 text-sm mb-6">Click below to complete your payment securely.</p>
