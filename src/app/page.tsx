    ...
    <div className="min-h-screen bg-[#050B14] text-white font-sans selection:bg-cyan-500 selection:text-white">
      ...
      <nav className="relative z-20 px-6 py-4 flex justify-between items-center">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-full bg-cyan-500 flex items-center justify-center"><span className="text-lg font-bold">❄</span></div>
      ...
      <section className="relative z-20 py-12 px-6 bg-[#050B14]">
        <div className="max-w-6xl mx-auto bg-[#0B1120] border border-slate-800 rounded-3xl p-8 shadow-2xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div className="p-4 rounded-2xl bg-slate-800/30 border border-slate-700/50"><div className="text-xs text-blue-400 font-bold uppercase mb-2">USA</div><div className="text-2xl md:text-3xl font-mono font-bold text-white tabular-nums">{stats.usa.toLocaleString()}</div></div>
            <div className="p-4 rounded-2xl bg-slate-800/30 border border-slate-700/50"><div className="text-xs text-orange-400 font-bold uppercase mb-2">INDIA</div><div className="text-2xl md:text-3xl font-mono font-bold text-white tabular-nums">{stats.india.toLocaleString()}</div></div>
            <div className="p-4 rounded-2xl bg-slate-800/30 border border-slate-700/50"><div className="text-xs text-red-400 font-bold uppercase mb-2">CHINA</div><div className="text-2xl md:text-3xl font-mono font-bold text-white tabular-nums">{stats.china.toLocaleString()}</div></div>
            <div className="p-4 rounded-2xl bg-slate-800/30 border border-green-500/50 shadow-[0_0_15px_rgba(34,197,94,0.2)]"><div className="text-xs text-green-400 font-bold uppercase mb-2">SOUTH AFRICA</div><div className="text-2xl md:text-3xl font-mono font-bold text-white tabular-nums">{stats.southAfrica.toLocaleString()}</div></div>
          </div>
