    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-20 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <a href="#products" className="px-8 py-4 bg-blue-500 hover:bg-blue-600 rounded-full font-bold text-lg transition transform hover:scale-105 shadow-lg inline-block">
            Browse Products
          </a>
        </div>
      </section>
              ...
              <div key={product.id} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition duration-300 transform hover:-translate-y-2">
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center mt-4">
                    ...
                    <button className="px-4 py-2 bg-slate-900 text-white rounded-lg hover:bg-blue-600 transition">Buy Now</button>
                  </div>
                </div>
              </div>
            ))}
