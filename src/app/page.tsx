...
export default function HomePage() {
  ...
  // ✅ CALCULATE REAL TOTALS FROM LIVE DATA (This is the ONLY change needed)
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      {/* ✅ FIRST TRACKER - NOW USING REAL DATA (totalOrders, totalRevenue) */}
      ...
      {/* ✅ SECOND TRACKER - UNCHANGED (Your working code stays exactly as is) */}
