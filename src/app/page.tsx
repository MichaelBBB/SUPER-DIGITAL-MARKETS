      ...
      <div className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-extrabold mb-6 leading-tight tracking-tight text-white drop-shadow-lg">
            ...
            Digital Products <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-orange-500">Delivered Instantly.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center items-center">
            <Link href="/products" className="w-full sm:w-auto px-10 py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-full font-bold text-lg shadow-xl shadow-blue-600/40 transition-all transform hover:-translate-y-1 hover:shadow-2xl">
              Browse Products
            </Link>
            <Link href="/payment?item=Test&amount=10.99" className="w-full sm:w-auto px-10 py-4 bg-emerald-600 hover:bg-emerald-700 text-white rounded-full font-bold text-lg shadow-xl shadow-emerald-600/40 transition-all transform hover:-translate-y-1 hover:shadow-2xl">
              Test Payment
            </Link>
          </div>
        </div>
