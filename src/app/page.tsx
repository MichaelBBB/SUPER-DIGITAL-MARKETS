...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <a href="#payment-guide" className="text-sm text-gray-300 hover:text-white transition">How Do I Pay?</a>
          ...
          {isMenuOpen && (
            <div className="md:hidden mt-4 pb-4 space-y-2">
              ...
              <a href="#payment-guide" className="block px-4 py-2 hover:bg-white/5 rounded-lg">How Do I Pay?</a>
            </div>
          )}
        </div>
      </nav>
      ...
      {/* PAYMENT GUIDE SECTION - SCROLLABLE */}
      <section id="payment-guide" className="py-20 bg-slate-950 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-6">
