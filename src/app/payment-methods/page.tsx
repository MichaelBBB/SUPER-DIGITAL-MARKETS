...
const paymentMethods = [
  { 
    ...
    region: 'India', 
    tag: 'INDIA PRIMARY', 
    tagColor: 'bg-blue-900/50 text-blue-300 border-blue-800',
    flag: '🇮🇳'
  },
  { 
    id: 'alipay', 
  ...
  { 
    ...
    region: 'USA', 
    tag: 'USA PRIMARY', 
    tagColor: 'bg-red-900/50 text-red-300 border-red-800',
    flag: '🇺🇸'
  },
  { 
    id: 'googlepay', 
  ...
  { 
    ...
    region: 'South Africa', 
    tag: 'SA PRIMARY', 
    tagColor: 'bg-orange-900/50 text-orange-300 border-orange-800',
    flag: '🇿🇦'
  },
  { 
    id: 'capitec', 
...
export default function PaymentMethods() {
  ...
  const activeMethod = paymentMethods.find(m => m.id === activeId);
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7">
            <div className="p-8 bg-slate-900/50 rounded-2xl border border-slate-800 backdrop-blur-sm h-full flex flex-col justify-center">
              
              {/* Capitec Specific Content (Matches Screenshot) */}
              {activeId === 'capitec' && (
                <>
              ...
              {/* Placeholder for other methods (to prevent blank space) */}
              {activeId !== 'capitec' && (
