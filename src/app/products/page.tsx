  ...
  return (
    <div className="min-h-screen bg-[#0B1120] text-white py-12 px-4">
      <div className="max-w-7xl mx-auto">
        <Link href="/" className="text-cyan-400 hover:underline mb-6 inline-block text-sm font-medium">← Back to Home</Link>
            ...
            <div key={p.id} className="bg-[#0F172A] border border-slate-800/50 rounded-2xl overflow-hidden hover:border-cyan-500/50 transition-all duration-300 group">
              ...
              <div className="relative h-48 overflow-hidden">
                ...
                {p.badge && (
                  <span className={`absolute top-3 left-3 px-3 py-1 rounded-full text-xs font-bold ${
                    p.badge === 'HOT' ? 'bg-red-500' : p.badge === 'NEW' ? 'bg-green-500' : 'bg-yellow-500'
                  }`}>
                    {p.badge}
                  </span>
                )}
                <span className="absolute top-3 right-3 px-3 py-1 rounded-full text-xs font-bold bg-slate-900/80 text-cyan-300 backdrop-blur-sm">
                  {p.category}
                </span>
              </div>
              ...
              <div className="p-5">
                ...
                <Link 
                  ...
                  className="w-full bg-gradient-to-r from-cyan-600 to-cyan-400 hover:from-cyan-500 hover:to-cyan-300 text-white font-bold py-3 px-6 rounded-xl transition-all flex items-center justify-center gap-2 shadow-lg shadow-cyan-900/20 hover:shadow-cyan-500/30"
                >
