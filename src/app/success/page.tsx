    ...
    <div className="min-h-screen bg-[#0f1115] text-white flex items-center justify-center p-6">
      <div className="text-center max-w-md px-6">
        ...
        <div className="flex flex-col gap-3">
          <Link href="/products" className="bg-blue-600 hover:bg-blue-500 text-white py-3 px-8 rounded-xl font-bold">
            Browse Products
          </Link>
          
          <Link href="/" className="bg-gray-800 hover:bg-gray-700 text-white py-3 px-8 rounded-xl font-bold">
            Back to Home
          </Link>
        </div>
      </div>
